...
/// The longest TTL a received record is kept for, in seconds: 75 minutes,
/// what RFC 6762 §10 recommends for records other than host names. The TTL
/// is the sender's choice, and a record kept for up to 136 years (the u32
/// range) is a record kept forever.
pub(crate) const MAX_RECEIVED_TTL: u32 = 4500;
