...
# Export main() and nothing else (src/dynamic.list; Harbour 1.7), rather
# than -rdynamic, which would export every symbol of the Rust library.
QMAKE_LFLAGS += -Wl,--dynamic-list=$$PWD/dynamic.list
